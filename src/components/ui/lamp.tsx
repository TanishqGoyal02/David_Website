  ...
  return (
    <LampContainer>
      ...
      <div
        ...
        data-url="https://calendly.com/tanishqgoyal?hide_landing_page_details=1&hide_gdpr_banner=1"
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        >
          <div className="absolute w-[100%] left-0 bg-transparent h-full bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
